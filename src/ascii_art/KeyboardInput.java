...
//Project steps:
//    Add white pixels so length&width are 2^somethihng
//
//Divide into sub pictures depending on the size of original
//Each subpicure use formula to calculate brightness
//    switch brighness with Ascii char closest
